...
public class stu_11_12 extends javax.swing.JFrame {

    /**
     * Creates new form stu_11_12
     */
    public stu_11_12() {
        initComponents();
        display();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("STUDENTS TIME => 11 : 00 - 12 : 15");
    ...
    private Connection getconnection(){
        ...
        //    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost/student_db_1","root","");
            ...
            Logger.getLogger(stu_11_12.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "failse");
            return null;
        }       
    }
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
       ...
       if(txtf_name.getText().equals("")||txtl_name.getText().equals("")||course.getText().equals("")||phone.equals("")){
           ...
           try {
               con = getconnection();
               ps = (PreparedStatement) con.prepareStatement("INSERT INTO `s2`(`id`, `fname`, `lname`, `course`, `phone`) VALUES (null,'"+txtf_name.getText()+"','"+txtl_name.getText()+"','"+course.getText()+"','"+phone.getText()+"')");
               ps.executeUpdate();
               display();
                txtf_name.setText("");
                txtl_name.setText("");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
           ...
           return;
             ...
             try {
                 ...
                 ps=(PreparedStatement) con.prepareStatement("UPDATE `s2` SET  `fname`='"+txtf_name.getText()+"',`lname`='"+txtf_name.getText()+"',`course`='"+course.getText()+"',`phone`='"+phone.getText()+"' WHERE  id = '"+id+"' ");
                 ps.executeUpdate();
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
           try {
            Connection con = getconnection();
            ps=(PreparedStatement) con.prepareStatement("DELETE FROM `s2` WHERE id=?");
            int id = Integer.parseInt(txtid.getText());
            ps.setInt(1, id);
            ps.executeUpdate();
            display();
    ...
    private void display(){
          try {
            Connection con = getconnection();
            ps = (PreparedStatement) con.prepareStatement("SELECT * FROM `s2` ");
            re=ps.executeQuery();
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0);
            while(re.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stu_11_12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
